...
document.createElement("canvas").getContext || function () {
    ...
    function C(e) {
        ...
        r.length == 4 && e.substr(3, 1) == "a" ? alpha = Number(r[3]) : r[3] = 1;
        return r
    }
    ...
    function A(e) {
        var t, n, r;
        h = parseFloat(e[0]) / 360 % 360;
        h < 0 && h++;
        s = L(k(e[1]), 0, 1);
        l = L(k(e[2]), 0, 1);
        if (s == 0)t = n = r = l; else {
            var i = l < .5 ? l * (1 + s) : l + s - l * s, o = 2 * l - i;
            t = O(o, i, h + 1 / 3);
            n = O(o, i, h);
            r = O(o, i, h - 1 / 3)
        }
    ...
    function O(e, t, n) {
        n < 0 && n++;
        n > 1 && n--;
        return 6 * n < 1 ? e + (t - e) * 6 * n : 2 * n < 1 ? t : 3 * n < 2 ? e + (t - e) * (2 / 3 - n) * 6 : e
    }
    ...
    function M(e) {
        ...
        if (e.charAt(0) == "#")t = e; else if (/^rgb/.test(e)) {
            var r = C(e), t = "#", i;
            for (var s = 0; s < 3; s++) {
                r[s].indexOf("%") != -1 ? i = Math.floor(k(r[s]) * 255) : i = Number(r[s]);
                t += b[L(i, 0, 255)]
            }
            n = r[3]
        } else if (/^hsl/.test(e)) {
    ...
    function H(e, t) {
        ...
        typeof e.size == "number" ? n.size = e.size : e.size.indexOf("px") != -1 ? n.size = s : e.size.indexOf("em") != -1 ? n.size = i * s : e.size.indexOf("%") != -1 ? n.size = i / 100 * s : e.size.indexOf("pt") != -1 ? n.size = s / .75 : n.size = i;
        n.size *= .981;
        return n
    }
    ...
    function R(e, t) {
        ...
        s < 1 && (i *= s);
        t.push("<g_vml_:stroke", ' opacity="', i, '"', ' joinstyle="', e.lineJoin, '"', ' miterlimit="', e.miterLimit, '"', ' endcap="', j(e.lineCap), '"', ' weight="', s, 'px"', ' color="', r, '" />')
    }

    function U(t, n, r, i) {
        var s = t.fillStyle, o = t.arcScaleX_, a = t.arcScaleY_, f = i.x - r.x, l = i.y - r.y;
        if (s instanceof X) {
            var c = 0, h = {x: 0, y: 0}, p = 0, d = 1;
            if (s.type_ == "gradient") {
                var v = s.x0_ / o, m = s.y0_ / a, g = s.x1_ / o, y = s.y1_ / a, b = t.getCoords_(v, m), w = t.getCoords_(g, y), E = w.x - b.x, S = w.y - b.y;
                c = Math.atan2(E, S) * 180 / Math.PI;
                c < 0 && (c += 360);
                c < 1e-6 && (c = 0)
            } else {
                var b = t.getCoords_(s.x0_, s.y0_);
                h = {x: (b.x - r.x) / f, y: (b.y - r.y) / l};
                f /= o * u;
                l /= a * u;
                var x = e.max(f, l);
                p = 2 * s.r0_ / x;
    ...
    function J(e) {
        (!e || e.nodeType != 1 || e.tagName != "IMG") && $("TYPE_MISMATCH_ERR");
        e.readyState != "complete" && $("INVALID_STATE_ERR")
    }
    ...
    var e = Math, t = e.round, n = e.sin, r = e.cos, i = e.abs, o = e.sqrt, u = 10, a = u / 2, c = Array.prototype.slice;
    v(document);
    var m = {
        init: function (e) {
            if (/MSIE/.test(navigator.userAgent) && !window.opera) {
                ...
                t.attachEvent("onreadystatechange", p(this.init_, this, t))
            }
        }, init_: function (e) {
            ...
            if (!e.getContext) {
                ...
                v(e.ownerDocument);
                e.innerHTML = "";
                e.attachEvent("onpropertychange", g);
                e.attachEvent("onresize", y);
                var t = e.attributes;
                t.width && t.width.specified ? e.style.width = t.width.nodeValue + "px" : e.width = e.clientWidth;
                t.height && t.height.specified ? e.style.height = t.height.nodeValue + "px" : e.height = e.clientHeight
            }
            return e
        }
    };
    ...
    I.quadraticCurveTo = function (e, t, n, r) {
        var i = this.getCoords_(e, t), s = this.getCoords_(n, r), o = {
    ...
    I.arc = function (e, t, i, s, o, f) {
        i *= u;
        var l = f ? "at" : "wa", c = e + r(s) * i - a, h = t + n(s) * i - a, p = e + r(o) * i - a, d = t + n(o) * i - a;
        c == p && !f && (c += .125);
    ...
    I.drawImage = function (n, r) {
        var i, s, o, a, f, l, c, h, p = n.runtimeStyle.width, d = n.runtimeStyle.height;
        ...
        if (this.m_[0][0] != 1 || this.m_[0][1] || this.m_[1][1] != 1 || this.m_[1][0]) {
            ...
            var T = g, N = this.getCoords_(i + o, s), C = this.getCoords_(i, s + a), k = this.getCoords_(i + o, s + a);
            T.x = e.max(T.x, N.x, C.x, k.x);
            T.y = e.max(T.y, N.y, C.y, k.y);
            w.push("padding:0 ", t(T.x / u), "px ", t(T.y / u), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", x.join(""), ", sizingmethod='clip');")
        } else w.push("top:", t(g.y / u), "px;left:", t(g.x / u), "px;");
        w.push(' ">', '<g_vml_:image src="', n.src, '"', ' style="width:', u * o, "px;", " height:", u * a, 'px"', ' cropleft="', f / v, '"', ' croptop="', l / m, '"', ' cropright="', (v - f - c) / v, '"', ' cropbottom="', (m - l - h) / m, '"', " />", "</g_vml_:group>");
        this.element_.insertAdjacentHTML("BeforeEnd", w.join(""))
    };
    I.stroke = function (e) {
        var n = 10, r = 10, i = 5e3, s = {x: null, y: null}, o = {x: null, y: null};
    ...
    I.getCoords_ = function (e, t) {
        var n = this.m_;
        return {x: u * (e * n[0][0] + t * n[1][0] + n[2][0]) - a, y: u * (e * n[0][1] + t * n[1][1] + n[2][1]) - a}
    };
    I.save = function () {
        var e = {};
        T(this, e);
    ...
    I.drawText_ = function (e, n, r, i, s) {
        var o = this.m_, a = 1e3, f = 0, l = a, c = {
            x: 0,
            y: 0
        }, h = [], p = H(P(this.font), this.element_), v = B(p), m = this.element_.currentStyle, g = this.textAlign.toLowerCase();
        switch (g) {
            case"left":
            case"center":
            case"right":
        ...
        h.push('<g_vml_:line from="', -f, ' 0" to="', l, ' 0.05" ', ' coordsize="100 100" coordorigin="0 0"', ' filled="', !s, '" stroked="', !!s, '" style="position:absolute;width:1px;height:1px;">');
        s ? R(this, h) : U(this, h, {x: -f, y: 0}, {x: l, y: p.size});
        var b = o[0][0].toFixed(3) + "," + o[1][0].toFixed(3) + "," + o[0][1].toFixed(3) + "," + o[1][1].toFixed(3) + ",0,0", w = t(y.x / u) + "," + t(y.y / u);
        h.push('<g_vml_:skew on="t" matrix="', b, '" ', ' offset="', w, '" origin="', f, ' 0" />', '<g_vml_:path textpathok="true" />', '<g_vml_:textpath on="true" string="', d(e), '" style="v-text-align:', g, ";font:", d(v), '" /></g_vml_:line>');
